...
<div class="main">
    ...
    <div class="section-2 section-bawah section d-flex flex-column align-items-center"> 
        ...
        <div class="topic d-flex align-items-center justify-content-center mt-4">
            <a href=""><p class="font-gradient font-goudy fw-bold pe-4">COMPETITION</p></a>
            <p class="font-gradient font-goudy fw-bold">|</p>
            <a href=""><p class="font-gradient font-goudy fw-bold ps-4">GALLERY</p></a>
        </div>
